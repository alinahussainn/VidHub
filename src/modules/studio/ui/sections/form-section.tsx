...
const FormSectionSkeleton = () => {
 ...
 const FormSectionSuspense= ({videoId} : FormSectionProps) => {
    ...
    const generateDescription = trpc.videos.generateTitle.useMutation({
        onSuccess: () => {
...
<ThumbnailUploadModal
        ...
        <div className="flex items-center justify-between mb-66">
            <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
            ...
            <div className="flex flex-col gap-y-8 lg:col-span-2">
                <div className="flex flex-col gap-4 bg-[#F9F9F9] rounder-xl overflow-hidden h-fit">
                    <VideoPlayer
